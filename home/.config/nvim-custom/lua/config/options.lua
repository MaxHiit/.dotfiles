...
-- Folding --
-- Configured for nvim-ufo plugin
-- nvim-ufo overrides foldmethod internally — these values are required
vim.opt.foldcolumn = "0"	-- Hide fold column (no visual indicator on the left)
vim.opt.foldenable = true	-- Enable folding
vim.opt.foldlevel = 99	        -- Open all folds by default
vim.opt.foldlevelstart = 99	-- Start editing with all folds open
vim.opt.foldnestmax = 5     	-- Max fold nesting depth
